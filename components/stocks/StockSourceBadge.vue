<template>
  <span class="inline-flex items-center rounded-md px-2 py-0.5 text-[11px] font-semibold border" :class="badgeClass">
    {{ label }}
  </span>
</template>
...
const label = computed(() => {
  return t(`stock.watchlist.sourceTypes.${props.sourceType}`, props.sourceType)
})
