...
<template>
  <div class="discipline-page">
    ...
    <div class="fixed inset-0 pointer-events-none" style="opacity: 0.03;">
    ...
    <div style="height: 2px; background: linear-gradient(90deg, transparent, #C9A962, transparent);"></div>
